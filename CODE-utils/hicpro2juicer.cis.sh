...
/lustre1/lch3000_pkuhpc/jialm/Software/HiC-Pro_2.11.1/bin/utils/hicpro2juicebox_cw.q10.sh -i ${In1}.cis.shufall -g ${Gsize} -j /lustre1/lch3000_pkuhpc/jialm/Software/bin/juicer_tools_1.22.01.jar -t ./tmp -o ${out1}

/lustre1/lch3000_pkuhpc/jialm/Software/HiC-Pro_2.11.1/bin/utils/hicpro2juicebox_cw.q10.sh -i ${In2}.cis.shufall -g ${Gsize} -j /lustre1/lch3000_pkuhpc/jialm/Software/bin/juicer_tools_1.22.01.jar -t ./tmp -o ${out2}
