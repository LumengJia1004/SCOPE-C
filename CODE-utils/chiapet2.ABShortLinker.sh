...
/lustre1/lch3000_pkuhpc/jialm/Software/bin/ChIA-PET2_0.9.3/bin/ChIA-PET2 -g ${Genome} -b ${Gsize} -f ${R1} -r ${R2} -A TAAG -B ATGT -o ${Output} -n ${Prefix} -t 20 -k 1 -C 1 -m 0 -d 1 
