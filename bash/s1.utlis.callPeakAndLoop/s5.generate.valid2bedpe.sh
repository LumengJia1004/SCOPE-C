...
#for f in `find ../../CleanData/allValidPairs/human/human_humanBrain20220321-append/ | grep -v 'iPC'`
#for f in `find ../../CleanData/allValidPairs/mouse/mouse_data_20220125sent-append/ -name 'all*'`
#for f in `find ../../CleanData/allValidPairs/macaca/macaca_data_20220111-append/ -name 'all*'`
for f in `find ../../CleanData/allValidPairs/human/human_humanNew-220516-PFCandV1-append/ | grep 'merge.AB'`
do
dir=${f}
